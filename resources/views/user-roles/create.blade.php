...
@section('content')
<div class="d-flex justify-content-between align-items-center mb-4"><h1 class="h3 mb-0">Assign User Role</h1><a href="{{ route('user-roles.index') }}" class="btn btn-outline-secondary">Back</a></div>
